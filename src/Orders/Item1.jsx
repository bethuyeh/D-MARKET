...
import item1IMG from '../CatalogueIMG/Fashion 10.jpg';
import Footer from '../Components/Footer';
import { FaShoppingCart } from 'react-icons/fa';

function Item1({ cart, setCart }) {
    ...
    const handleAddToCart = () => {
        if (size) {
            setCart([...cart, { id: 1,  image: item1IMG, name: 'Brown Long Sleeved Kaftan', price: 15000, size }]);
            setSize('');
        } else {
        ...
        <div className='w-full relative'>
            ...
            <div className='max-w-[1240px] grid md:grid-cols-2 mx-auto gap-10 mt-10 mb-10'>
                ...
                <div className='flex flex-col items-center p-4 bg-white rounded-lg shadow-lg mx-auto mt-10 mb-10'>
                    <h1 className='text-3xl md:text-4xl mt-8'>Brown Long Sleeved Kaftan</h1>
