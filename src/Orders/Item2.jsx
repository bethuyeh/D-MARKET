...
import item2IMG from '../CatalogueIMG/Fashion 13.jpg';
import Footer from '../Components/Footer';
import { FaShoppingCart } from 'react-icons/fa';

function Item2({ cart, setCart }) {
    ...
    const handleAddToCart = () => {
        if (size) {
            setCart([...cart, { id: 2,  image: item2IMG, name: 'Gray Long Sleeved Kaftan', price: 15000, size }]);
            setSize('');
        } else {
