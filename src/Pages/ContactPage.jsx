            ...
            <div className= 'relative z-0 bg-white rounded-xl shadow-lg p-8 text-gray-600 md:w-80'>
              ...
              <form className='flex flex-col space-y-4'>
                ...
                <div>
                  ...
                  <button type='submit' className='inline-block self-end bg-cream text-white hover:bg-gray-500 bg-gray-800 font-bold rounded-lg px-6 py-2 uppercase text-sm'>Send Message</button>
